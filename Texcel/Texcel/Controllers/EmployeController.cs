...
namespace Texcel
{
    class EmployeController : Controller
    {
        ...
        {
            Provider.ExecuterCommande("INSERT INTO tblEmploye VALUES (@0, @1, @2, @3, @4, @5, @6, @7, @8, @8)",
        ...
        public override void Select(string where)
        {
            ...
            listEmploye.Clear();
            foreach(object[] employeSelectionne in Provider.CommandeLecture("SELECT * FROM tblEmploye " + where))
            {
